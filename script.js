document.addEventListener("DOMContentLoaded", () => {
    ...
    window.addEventListener("scroll", () => {
        if (window.scrollY > 200) {
            document.body.style.backgroundColor = "#f5d1abff";} 
        else {
            document.body.style.backgroundColor = "#f6c370ff";}
    });
...
greetBtn.addEventListener("click", function () {
    ...
    if (nama) {
     ...
     /*Reflesi 
     semuanya sulit dan ketika kodenya berhasil saya merasa sangat gembira pikiran plong🥰
